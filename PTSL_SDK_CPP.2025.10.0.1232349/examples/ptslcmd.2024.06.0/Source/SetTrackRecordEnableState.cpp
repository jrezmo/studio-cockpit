...
/**
 * @file
 * @brief ptslcmd.cpp wrapper for the PTSLC_CPP::CppPTSLClient::SetTrackRecordEnableState command.
 */

#include "Common.h"

const string g_pszSetTrackRecordEnableState = "SetTrackRecordEnableState";
const string g_pszSetTrackRecordEnableStateHelp =
    "SetTrackRecordEnableState -track_names <track_name> [<track_name> ...] -enabled <true|false>";

PtslCmdCommandResult SetTrackRecordEnableState(const vector<string>& params, CppPTSLClient& client)
{
    // Create a request:
    SetTrackRecordEnableStateRequest request;
    request.commandType = CommandType::SetTrackRecordEnableState;
    ...
    std::shared_ptr<CommandResponse> rsp = client.SetTrackRecordEnableState(request);
