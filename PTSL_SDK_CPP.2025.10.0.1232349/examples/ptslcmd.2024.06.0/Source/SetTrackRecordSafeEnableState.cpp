...
/**
 * @file
 * @brief ptslcmd.cpp wrapper for the PTSLC_CPP::CppPTSLClient::SetTrackRecordSafeEnableState command.
 */

#include "Common.h"

const string g_pszSetTrackRecordSafeEnableState = "SetTrackRecordSafeEnableState";
const string g_pszSetTrackRecordSafeEnableStateHelp =
    "SetTrackRecordSafeEnableState -track_names <track_name> [<track_name> ...] -enabled <true|false>";

PtslCmdCommandResult SetTrackRecordSafeEnableState(const vector<string>& params, CppPTSLClient& client)
{
    // Create a request:
    SetTrackRecordSafeEnableStateRequest request;
    request.commandType = CommandType::SetTrackRecordSafeEnableState;
    ...
    std::shared_ptr<CommandResponse> rsp = client.SetTrackRecordSafeEnableState(request);
