...
/**
 * @file
 * @brief Implementation of the PTSLC_CPP::CppPTSLClient::CreateFadesBasedOnPreset command.
 */
...
namespace PTSLC_CPP
{
    std::shared_ptr<CommandResponse> CppPTSLClient::CreateFadesBasedOnPreset(
        const CreateFadesBasedOnPresetRequest& request)
    {
