...
/**
 * @file
 * @brief Implementation of the PTSLC_CPP::CppPTSLClient::RenameTrack command.
 *
...
namespace PTSLC_CPP
{
    std::shared_ptr<CommandResponse> CppPTSLClient::RenameTrack(const RenameTargetTrackRequest& request)
    {
