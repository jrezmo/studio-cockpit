...
/**
 * @file
 * @brief Implementation of the PTSLC_CPP::CppPTSLClient::EditMemoryLocation command.
 */
...
namespace PTSLC_CPP
{
    std::shared_ptr<CommandResponse> CppPTSLClient::EditMemoryLocation(const EditMemoryLocationRequest& request)
    {
        struct EditMemoryLocationHandler : public DefaultRequestHandler
        {
        public:
            INIT_HNDLR_OVRD(EditMemoryLocation);

            std::string GetRequestName() const override
            {
                return "AsyncEditMemoryLocation";
            }
        ...
        private:
            void FillGrpcRequest(const EditMemoryLocationRequest& request)
            {
            ...
            ptsl::EditMemoryLocationRequestBody mGrpcRequestBody;
            ptsl::EditMemoryLocationResponseBody mGrpcResponseBody;
        };

        MAKE_REQUEST(EditMemoryLocation, /*HAS_REQ*/ true, /*IS_STREAMING*/ true);
